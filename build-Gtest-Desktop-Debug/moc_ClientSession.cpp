...
#include <memory>
#include "../ServerApp/ClientSession.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ClientSession_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(27, 14) // "onDisconnected"
    ...
    "ClientSession\0onReadyRead\0\0onDisconnected"
};
...
const QMetaObject ClientSession::staticMetaObject = { {
    ...
    qt_meta_stringdata_ClientSession.offsetsAndSize,
